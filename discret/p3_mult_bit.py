...
class p3_mult(Scene):
    def construct(self):
        ...
        self.play(ReplacementTransform(kb, mb[0]), FadeOut(kb_text, brace))
        ...
        self.play(Transform(value, MathTex(f"{1024**2}").scale(2).to_edge(DOWN)))
        ...
        self.play(Transform(value, MathTex(f"{1024**3}").scale(2).to_edge(DOWN)))
        ...
        self.play(Transform(value, MathTex(f"{1024**4}").scale(2).to_edge(DOWN)))
