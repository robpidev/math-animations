...
class Prop9(Scene):
    def construct(self):
        ...
        m3 = MathTex(
            r"\text{M3. }", "x(yz) = (xy)z", r", \quad \forall x, y, z \in \mathbb{R}"
        )
        ...
        self.play(u2.animate.move_to([-4, -2, 0]), u2l.animate.move_to([-4.5, -1.5, 0]))
        ...
        self.play(ReplacementTransform(eq, eq_alt, transform_mismatches=True))
        self.wait()
        ...
        result = MathTex(
            ...
            r"\wedge",
            r"\forall \mathbf{u} \in \mathbb{R}^2",
        )
        ...
        self.play(
            TransformMatchingShapes(
                Group(l1[0], l1[-2]).copy(), l2[0], fade_transform_mismatches=True
            )
        )
        ...
        self.play(
            TransformMatchingShapes(l2[0].copy(), l2[2], transform_mismatches=True)
        )

        self.wait()
        self.play(Write(l2[3]))
        self.play(
            TransformMatchingShapes(l2[2].copy(), l2[4], transform_mismatches=True)
        )
        ...
        self.play(
            TransformMatchingShapes(l2[4].copy(), l2[6], transform_mismatches=True)
        )
        ...
        self.play(
            TransformMatchingShapes(l2[6].copy(), l2[8], transform_mismatches=True)
        )
        self.wait()
        ...
        self.play(
            FadeOut(l2[2:-1]),
            TransformMatchingShapes(
                Group(l2[0:2], l2[-1]), result[1:4], transform_mismatches=True
            ),
        )
        ...
        self.play(
            TransformMatchingShapes(
                l1, result[5:], transform_mismatches=True, path_arc=-PI / 2
            )
        )
        ...
        self.play(result.animate.scale(0.8).to_edge(UP + LEFT), FadeOut(m3))
        ...
        self.play(
            TransformMatchingShapes(
                eq[0].copy(), eq[2:], fade_transform_mismatches=True, path_arc=PI / 2
            )
        )

        self.wait()
        self.play(
            TransformMatchingShapes(eq[1:].copy(), eq1[1:], transform_mismatches=True)
        )
